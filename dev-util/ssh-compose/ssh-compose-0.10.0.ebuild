...
SRC_URI="https://api.github.com/repos/MottainaiCI/ssh-compose/tarball/v0.10.0 -> ssh-compose-0.10.0-a3393d5.tar.gz"
...
src_compile() {
	custom_ldflags=(
		...
		"-X github.com/MottainaiCI/ssh-compose/cmd.BuildCommit=a3393d5839995d734998c5c9ae4ad343aec49a86"
