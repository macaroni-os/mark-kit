...
SRC_URI="https://api.github.com/repos/MottainaiCI/lxd-compose/tarball/v0.39.1 -> lxd-compose-0.39.1-322813f.tar.gz"
...
src_compile() {
	custom_ldflags=(
		...
		"-X github.com/MottainaiCI/lxd-compose/cmd.BuildCommit=322813f50440d7b9dea7a00d75a6655360304e5e"
